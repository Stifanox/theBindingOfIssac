...
import door_right from "../../Img/door_left_boss.png"
import door_left from "../../Img/door_right_boss.png"


import door_right_closed from "../../Img/door_left_boss_closed.png"
import door_left_closed from "../../Img/door_right_boss_closed.png"

import { Player } from "./Player";

type doorDirection = "up"|"down"|"left"|"right"

export class DoorBoss implements EntityInterface{
    vx: number;
    vy: number;
    ...
    private setDirection(direction:doorDirection){
        switch(direction){
            case "left":
                this.imageSource = new SpriteAnimator([new AnimationObjectCreate(door_left,37,65,true,0,0,"static",0,0)])
            ...
            break
            case "right":
                this.imageSource = new SpriteAnimator([new AnimationObjectCreate(door_right,37,65,true,0,0,"static",0,0)])
                this.width = this.imageSource.spriteWidth + 50
                this.height = this.imageSource.spriteHeight + 40
                this.x = 885
                this.y = 275
