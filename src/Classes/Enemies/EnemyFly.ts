...
import { ImgEnemyFly } from "../../Importer/ImageImporter"
import { PlayfieldSize } from "../../Utils/PlayfiledSize";
export class EnemyFly extends FlyingEnemy {

    offsetOfBottomSize: number
    constructor(x: number, y: number) {
        super(0.1, 0.1, x, y, 10, new SpriteAnimator([new AnimationObjectCreate(ImgEnemyFly, 54, 49, false, 3, 64, "flying", 84, 32)]))
