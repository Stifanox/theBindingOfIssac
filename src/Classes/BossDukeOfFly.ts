...
import boss_duke from "../../Img/boss_duke.png"
...
export class BossDukeOfFly extends Enemy{
    ...
    constructor(x:number,y:number,enemies:Enemy[]){
        super(-0.15,-0.15,new SpriteAnimator([new AnimationObjectCreate(boss_duke,72,72,false,3,76,"duke_attack",16,0)]),x,y,300)
        this.width = 150
        this.height = 150
